...
class Trader:
    ...
    def _trade_pepper(self, product, d, pos, take_sig=0):
        ...
        if pos < 70:
            # iter32: tighter PEP accumulate cap. Log showed PEP BUY fills
            # averaged mid+$1.98 (negative edge). Cap reduces avg fill price.
            import os as _oo
            buy_limit = fv_int + int(_oo.environ.get("PEP_ACCUM_CAP", "3"))
            for ap in sorted(d.sell_orders):
