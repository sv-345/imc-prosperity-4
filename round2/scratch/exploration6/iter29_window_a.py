...
OSM_PHASE3_K = 5
PEP_PHASE3_K = 1
_WINDOWS_A = ((34300, 48100), (76100, 90100))
def _in_window_a(ts):
    for lo, hi in _WINDOWS_A:
...
class Trader:
    ...
    def _trade_pepper(self, product, d, pos, take_sig=0):
        ...
        if pos < 70:
            ...
            # iter29 variant A: within w1/w2, always skip recycle (hold long through drift).
            if _in_window_a(getattr(self, "_current_ts", 0)):
                base_sell = 0
