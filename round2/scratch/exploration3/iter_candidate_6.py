...
class Trader:
    ...
    def _trade_pepper(self, product, d, pos, take_sig=0):
        ...
        if pos < 70:
            # candidate-6: gate fast-accum buy_limit by take_sig.
            # When take_sig>0 (buy-takers present, mid rising), buy aggressively (fv+6).
            # When take_sig<=0 (sell-takers or neutral), cap buy at fv+3 (patient).
